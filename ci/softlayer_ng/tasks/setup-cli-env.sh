...
echo -e "\n\033[32m[INFO] Installing SoftLayer CLI.\033[0m"
...
echo -e "\n\033[32m[INFO] Using SoftLayer CLI: $(slcli --version).\033[0m"
...
slcli -y vs create -H bosh-cli-v2-softlayer-ng -D softlayer.com \
