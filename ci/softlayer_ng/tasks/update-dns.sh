...
bosh-cli int /data/xzd/deployment/cf/deployment/director-creds.yml --path /jumpbox_ssh/private_key > ./jumpbox.key
chmod 0600 ./jumpbox.key
ssh jumpbox@${director_ip} -i ./jumpbox.key 'bash -s' < update_dns.sh
