...
bosh-cli -n -e bosh-test -d ${deploy_name} deploy ${deployment_dir}/cf-deploy-base.yml --fix --no-redact
bosh-cli -n -e bosh-test -d ${deploy_name}-diego deploy ${deployment_dir}/diego-deploy-base.yml --fix --no-redact
